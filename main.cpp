...
void displayMenu();
void loadMapDataFromCSVfile(map<string, unique_ptr<Package>>&);
void displayMapData(map<string, unique_ptr<Package>>&);
void saveMapDataToBinaryFile(map<string, unique_ptr<Package>>&);
void loadMapDataFromBinaryFile(map<string, unique_ptr<Package>>&);
void displayPackagesByType(map<string, unique_ptr<Package>>&);
void displayPackagesByCost(map<string, unique_ptr<Package>>&);
void extractAndModifyPackage(map<string, unique_ptr<Package>>&);
...
void loadMapDataFromCSVfile(map<string, unique_ptr<Package>>& packages){
	if(packages.empty()){
...
void saveMapDataToBinaryFile(map<string, unique_ptr<Package>>& packages){
	if(packages.empty()){
...
void loadMapDataFromBinaryFile(map<string, unique_ptr<Package>>& packages){
	if(packages.empty()){
...
void displayPackagesByType(map<string, unique_ptr<Package>>& packages){
	if(!packages.empty()){
...
void displayPackagesByCost(map<string, unique_ptr<Package>>& packages){
    if(!packages.empty()){
   		vector<unique_ptr<Package>> sortedPackages;
        vector<string> keys;  
...
void extractAndModifyPackage(map<string, unique_ptr<Package>>& packages){
